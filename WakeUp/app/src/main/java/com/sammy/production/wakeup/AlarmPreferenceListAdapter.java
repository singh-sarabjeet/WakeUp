...
//
    ...
    public void setMathAlarm(Alarm alarm) {
        ...
        preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_TIME, "Set_time", alarm.getAlarmTimeString(), null, alarm.getAlarmTime(), AlarmPreference.Type.TIME));
